...
parser.add_argument(
    "--strategy", type=str, default="ddp", help="strategy to use for training"
)
parser.add_argument(
...
transform = torchvision.transforms.Compose(
    [
        ...
        torchvision.transforms.Normalize(
            mean=[0.4913, 0.482, 0.446], std=[0.247, 0.243, 0.261]
        ),
    ]
)
